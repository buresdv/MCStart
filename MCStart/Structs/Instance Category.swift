...
class InstanceCategories: ObservableObject {
    @Published var categories: [InstanceCategory] = [
        InstanceCategory(name: "Vanilla", iconSymbolName: "folder", instances: [
            Instance(name: "Server", version: "1.20", dateCreated: Date(), iconSymbolName: "rectangle.portrait.and.arrow.forward", mods: [], settings: InstanceSettings(javaExecutablePath: "/Users/david/Downloads", minMemory: 100, maxMemory: 5000)),
            Instance(name: "1.19", version: "1.19.3", dateCreated: Date(), iconSymbolName: "pencil.circle", mods: [], settings: InstanceSettings(javaExecutablePath: "/Applications", minMemory: 427, maxMemory: 2034)),
            Instance(name: "1.18", version: "1.18.2", dateCreated: Date(), iconSymbolName: "trash.slash", mods: [], settings: InstanceSettings(javaExecutablePath: "/Users/david/Documents", minMemory: 2489, maxMemory: 203477))
        ]),
        InstanceCategory(name: "Modded", iconSymbolName: "internaldrive", instances: [
            ...
            Instance(name: "Permafrost - Eyes of the Storm", version: "1.15.2", dateCreated: Date(), iconSymbolName: "person.badge.shield.checkmark.fill", mods: [
            ...
            Instance(name: "Ars Technica", version: "1.19.3", dateCreated: Date(), iconSymbolName: "baseball.fill", mods: [
