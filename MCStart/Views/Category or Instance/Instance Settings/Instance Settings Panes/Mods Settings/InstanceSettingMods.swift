                ...
                HStack
                {
                    if availableMods.allSatisfy({ $0.isEnabled == true })
                    {
                        Button
                        {
                            ...
                            { // It has to be written this way because I need to access the index of the mod in its parent array to change its isEnabled value. Otherwise it just does nothing
                                disableMod(mod: mod)
